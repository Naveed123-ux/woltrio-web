...
const Tech = () => {
  return (
    <div className="row gx-0 bg-dark-slate ">
      <div className="col-md-10  mx-auto  m-4">
        <div className="row w-auto svgwdth   d-flex   justify-content-center  ">
          <div className="col-md-2 border divsInside">
            <div className="row align-items-center justify-content-center p-3 border -bottom divsInside">
              <i style={{ width: "100px" }}>
                <svg
          ...
          <div className="col-md-2 d-flex align-items-center border  divsInside ">
          ...
          <div className="col-md-2   border  divsInside">
            <div className="row align-items-center justify-content-center border-bottom p-3 divsInside">
              <i style={{ width: "100px" }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512 "
            ...
            <div className="row align-items-center justify-content-center p-3 divsInside">
              <i style={{ width: "100px" }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 384 512"
          ...
          <div className="col-md-2 border   d-flex align-items-center divsInside">
            <div className="row mx-auto align-items-center justify-content-center p-3">
              <i style={{ width: "100px" }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
